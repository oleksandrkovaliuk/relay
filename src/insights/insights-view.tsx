...
/** Loaded after the page has painted; see submission-chart.tsx. */
const SubmissionChartCanvas = lazy(() => import("./submission-chart"));
...
function SubmissionChart({
  ...
  return (
    <Suspense fallback={<Skeleton className="h-44 w-full lg:h-48" />}>
      <SubmissionChartCanvas dailySubmissions={dailySubmissions} />
    </Suspense>
  );
}
